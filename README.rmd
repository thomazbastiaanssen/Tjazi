...
* Third, if $x_{n}$ is exactly the same as the geometric mean $G({\bf x})$, $\frac{{x}_{n}}{G({\bf x})}$ will be 1 and thus $clr({x}_{n})$ will be 0 as the logarithm of 1 is equal to 0. This gives us some intuition about the size of CLR-transformed values. 
