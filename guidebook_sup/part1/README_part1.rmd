...
```{r Stacked_Barplots, message = FALSE, fig.width=16, fig.height=14}
...
```{r Alpha_Diversity, cache = TRUE, message = FALSE, warning = FALSE}
...
```{r Differential_Abundance, message = FALSE, fig.width=16, fig.height=14, warning = FALSE}
...
```{r Checking_out_fw_glm_output, message = FALSE, fig.width=16, fig.height=14, warning = FALSE}
glimpse(genus.glm)
```
...
```{r Plot_differentially_abundant_genera, warning = FALSE, message = FALSE, fig.width=16, fig.height=9}
...
```{r Load_Gut_Brain_Modules, message = FALSE, cache = T, fig.width=16, fig.height=14}
...
```{r Plot_GBMs, message = FALSE, warning = FALSE, fig.width=16, fig.height=7}
...
```{r Load_Gut_Metabolic_Modules, message = FALSE, cache = T, fig.width=16, fig.height=18}
#Ensure reproducibility within this document
set.seed(1)
...
```{r Plot_GMMs, message = FALSE, warning = FALSE, fig.width=16, fig.height=20}
#Plot the features that show a group effect at q < 0.2
